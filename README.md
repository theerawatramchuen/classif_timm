...
#### Running training and inferencing with other pretrained weight model list in timm library
1. open "timm_classif.ipynp" with Jupyter notebook <br/>
2. Define dataset folder in 2nd cell <br/>
3. Define training hyper parameters in 3rd cell <br/>
4. Define Data augmentation and normalization for training in 4th cell <br/>
5. Define pretrained weight model in 9th cell <br>
